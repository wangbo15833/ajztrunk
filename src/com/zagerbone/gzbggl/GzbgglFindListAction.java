...
// Source File Name:   GzbgglFindListAction.java
...
public class GzbgglFindListAction extends BaseActionSupport
{

	public GzbgglFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = null;
			if (i == 0)
				query1 = gzbggldao.findGzbgglList_noPage(query);
			else
				query1 = gzbggldao.findGzbgglList(query);
