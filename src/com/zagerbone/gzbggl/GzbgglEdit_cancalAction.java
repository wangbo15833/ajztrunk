...
// Source File Name:   GzbgglEdit_cancalAction.java
...
public class GzbgglEdit_cancalAction extends BaseActionSupport
{

	public GzbgglEdit_cancalAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = gzbggldao.findGzbgglList(query);
