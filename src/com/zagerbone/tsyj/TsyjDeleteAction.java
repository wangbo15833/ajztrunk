...
public class TsyjDeleteAction extends BaseActionSupport
{

	public TsyjDeleteAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			System.out.println("===  step in TsyjDeleteAction === id is :"+s);
			String s1 = tsyjdao.deleteTsyj(s,event.getRequest());
