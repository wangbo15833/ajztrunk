...
//			TsyjDAOFactory, TsyjDAO

public class TsyjFindListAction extends BaseActionSupport
{

	public TsyjFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = tsyjdao.findTsyjList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in TsyjFindListAction is "+s3+" ===***");
		query.info();
