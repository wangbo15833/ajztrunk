...
//			SignruleDAOFactory, SignruleDAO

public class SignruleFindListAction extends BaseActionSupport
{

	public SignruleFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = signruledao.findSignruleList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in SignruleFindListAction is "+s3+" ===***");
		query.info();
