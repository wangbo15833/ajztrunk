...
public class TabmapQueryListAction extends BaseActionSupport
{

	public TabmapQueryListAction()
	{
	}
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in TabmapQueryListAction is "+s3+" ===***");
		query.info();
