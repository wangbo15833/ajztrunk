...
// Source File Name:   GzbzglEdit_cancalAction.java
...
public class GzbzglEdit_cancalAction extends BaseActionSupport
{

	public GzbzglEdit_cancalAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = gzbzgldao.findGzbzglList(query);
