...
//			SysdatasetDAOFactory, SysdatasetDAO

public class SysdatasetFindListAction extends BaseActionSupport
{

	public SysdatasetFindListAction()
	{
	}
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in SysdatasetFindListAction is "+s3+" ===***");
		query.info();
