...
public class QzbaDeleteAction extends BaseActionSupport
{

	public QzbaDeleteAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			System.out.println("===  step in QzbaDeleteAction === id is :"+s);
			String s1 = qzbadao.deleteQzba(s,event.getRequest());
