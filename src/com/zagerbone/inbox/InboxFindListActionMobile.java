...
public class InboxFindListActionMobile extends BaseActionSupport
{

	public InboxFindListActionMobile()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = inboxdao.findInboxList(query,request);
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in InboxFindListActionMobile is "+s3+" ===***");
		query.info();
