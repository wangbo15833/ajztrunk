...
public class InboxFindGGListAction extends BaseActionSupport
{

	public InboxFindGGListAction()
	{
	}
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in InboxFindGGListAction is "+s3+" ===***");
		query.info();
