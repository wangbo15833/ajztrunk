...
//			UserinfoDAOFactory, UserinfoDAO

public class UserinfoFindListAction extends BaseActionSupport
{

	public UserinfoFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = userinfodao.findUserinfoList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in UserinfoFindListAction is "+s3+" ===***");
		query.info();
