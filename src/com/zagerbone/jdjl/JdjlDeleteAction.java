...
public class JdjlDeleteAction extends BaseActionSupport
{

	public JdjlDeleteAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			System.out.println("===  step in JdjlDeleteAction === id is :"+s);
			String s1 = jdjldao.deleteJdjl(s,event.getRequest());
