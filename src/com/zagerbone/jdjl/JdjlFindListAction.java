...
//			JdjlDAOFactory, JdjlDAO

public class JdjlFindListAction extends BaseActionSupport
{

	public JdjlFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = jdjldao.findJdjlList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in JdjlFindListAction is "+s3+" ===***");
		query.info();
