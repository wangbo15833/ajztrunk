...
//			GginfoDAOFactory, GginfoDAO

public class GginfoFindListAction extends BaseActionSupport
{

	public GginfoFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = gginfodao.findGginfoList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in GginfoFindListAction is "+s3+" ===***");
		query.info();
