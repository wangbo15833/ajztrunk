...
//			JdjhDAOFactory, JdjhDAO

public class JdjhFindListAction extends BaseActionSupport
{

	public JdjhFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = jdjhdao.findJdjhList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in JdjhFindListAction is "+s3+" ===***");
		query.info();
