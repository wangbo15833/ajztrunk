...
public class DeptModifyAction extends BaseActionSupport
{

	public DeptModifyAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		System.out.println("***=== DeptModifyAction mode is "+ mode+" ===***");
		try
		{
			...
			Dept dept = (Dept)processEvent(event);
			String s = deptdao.modifyDept(dept,event.getRequest());
			eventresponse.setSuccessFlag(true);
