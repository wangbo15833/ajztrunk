...
public class XmzgDeleteAction extends BaseActionSupport
{

	public XmzgDeleteAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			System.out.println("===  step in XmzgDeleteAction === id is :"+s);
			String s1 = xmzgdao.deleteXmzg(s,event.getRequest());
