...
//			SignupDAOFactory, SignupDAO

public class SignupFindListAction extends BaseActionSupport
{

	public SignupFindListAction()
	{
	}
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in SignupFindListAction is "+s3+" ===***");
		query.info();
