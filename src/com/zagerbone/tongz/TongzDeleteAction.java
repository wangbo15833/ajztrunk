...
public class TongzDeleteAction extends BaseActionSupport
{

	public TongzDeleteAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			System.out.println("===  step in TongzDeleteAction === id is :"+s);
			String s1 = tongzdao.deleteTongz(s,event.getRequest());
