...
// Source File Name:   FindUserBasicListAction.java
...
public class FindUserBasicListAction extends BaseActionSupport
{

	public FindUserBasicListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = userdao.findUserBasicList(query);
