...
// Source File Name:   SyyqglEdit_cancalAction.java
...
public class SyyqglEdit_cancalAction extends BaseActionSupport
{

	public SyyqglEdit_cancalAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = syyqgldao.findSyyqglList(query);
