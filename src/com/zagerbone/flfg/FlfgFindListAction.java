...
//			FlfgDAOFactory, FlfgDAO

public class FlfgFindListAction extends BaseActionSupport
{

	public FlfgFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = flfgdao.findFlfgList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in FlfgFindListAction is "+s3+" ===***");
		query.info();
