...
public class ThryDeleteAction extends BaseActionSupport
{

	public ThryDeleteAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			System.out.println("===  step in ThryDeleteAction === id is :"+s);
			String s1 = thrydao.deleteThry(s,event.getRequest());
