...
public class ThryModifyAction extends BaseActionSupport
{

	public ThryModifyAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		System.out.println("***=== ThryModifyAction mode is "+ mode+" ===***");
		try
		{
			...
			Thry thry = (Thry)processEvent(event);
			String s = thrydao.modifyThry(thry,event.getRequest());
			eventresponse.setSuccessFlag(true);
