...
//			ThryDAOFactory, ThryDAO

public class ThryFindListAction extends BaseActionSupport
{

	public ThryFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = thrydao.findThryList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in ThryFindListAction is "+s3+" ===***");
		query.info();
