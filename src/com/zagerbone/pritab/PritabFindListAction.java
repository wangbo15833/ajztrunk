...
//			PritabDAOFactory, PritabDAO

public class PritabFindListAction extends BaseActionSupport
{

	public PritabFindListAction()
	{
	}
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in PritabFindListAction is "+s3+" ===***");
		query.info();
