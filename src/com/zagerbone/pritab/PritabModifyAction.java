...
public class PritabModifyAction extends BaseActionSupport
{

	public PritabModifyAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		System.out.println("***=== PritabModifyAction mode is "+ mode+" ===***");
		try
		{
			...
			Pritab pritab = (Pritab)processEvent(event);
			String s = pritabdao.modifyPritab(pritab);
			eventresponse.setSuccessFlag(true);
