...
// Source File Name:   QxbzglEditAction.java
...
public class QxbzglEditAction extends BaseActionSupport
{

	public QxbzglEditAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = qxbzgldao.findQxbzglList(query);
