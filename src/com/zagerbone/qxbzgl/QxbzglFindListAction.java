...
// Source File Name:   QxbzglFindListAction.java
...
public class QxbzglFindListAction extends BaseActionSupport
{

	public QxbzglFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = null;
			if (i == 0)
				query1 = qxbzgldao.findQxbzglList_noPage(query);
			else
				query1 = qxbzgldao.findQxbzglList(query);
