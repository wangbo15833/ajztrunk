...
//			DwlxDAOFactory, DwlxDAO

public class DwlxFindListAction extends BaseActionSupport
{

	public DwlxFindListAction()
	{
	}
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in DwlxFindListAction is "+s3+" ===***");
		query.info();
