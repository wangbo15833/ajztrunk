...
// Source File Name:   JcbgglFindListAction.java
...
public class JcbgglFindListAction extends BaseActionSupport
{

	public JcbgglFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = null;
			if (i == 0)
				query1 = jcbggldao.findJcbgglList_noPage(query);
			else
				query1 = jcbggldao.findJcbgglList(query);
