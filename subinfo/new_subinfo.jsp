...
<form name="formHead" action="./MainServlet_sys" target="sframe"  method="post" onKeyDown="if(event.keyCode==13)event.keyCode=9" ><input class="putin" type="hidden" name="fid" value="UII00.00.04.03">
<div  id="man_zone" style="overflow-y:scroll; color:#333; margin:0 auto;align:center;">
  ...
  <div align="center" style="font-size:13px;width:1000px;">
    <table border=1 cellspacing=0 cellpadding=0 width=1000 style="text-align:left;">
      ...
      <tr>
		...
		<td> <input class="putin datepicker" ondblclick="autofil(this.id)" id="kgsj"  name="kgsj" value="----------"/></td>
      </tr>
      <tr>
        <td  valign=center>分包安全生产许可证编号：<input class="putin" ondblclick="autofil(this.id)" id="fbsafelic"  name="fbsafelic" /></td>
		<td><input class="putin datepicker" ondblclick="autofil(this.id)" id="jgsj"  name="jgsj" value="----------" /></td>
      </tr>
	  </table>
