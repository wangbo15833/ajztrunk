...
$('.font_px12_menu').contextMenu('myMenu1', {
  bindings: {
	'see': function(t) {
	  ...
	  show('MainServlet_sys?fid=UII00.00.04.08&sub_code='+ t.id.split("_")[1])
	}
  }
});
</script>
<div class="contextMenu" id="myMenu2" style="">
  <ul>
	<li id="query"><img src="./image2/icons/binocular.png" />过滤</li>
  </ul>
</div>
<script>
$('#maintitle,.colnamec').contextMenu('myMenu2', {
  bindings: {
	'query': function(t) {
	  //alert('Trigger was '+t.id+'\nAction was see');
	  show('MainServlet_sys?fid=UII00.00.04.06&mode=before')
	}
  }
});
</script>
