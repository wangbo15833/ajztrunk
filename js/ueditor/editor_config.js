...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["source","undo","redo","unlink","link","template","bold","italic","underline","forecolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","removeformat","formatmatch","paragraph","insertimage","wordimage"]]
