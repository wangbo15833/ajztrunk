...
document.write("<div id='meizzCalendarLayer' style='position: absolute; z-index: 9999; width: " + (cal_Width+4).toString() + "px; height: 193px; display: block'>");
...
function document.onclick()
{
    ...
    if(WebCalendar.eventSrc != target) hiddenCalendar();
