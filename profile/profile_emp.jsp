...
<form name="formHead" action="./MainServlet_sys" target="self" onKeyDown="if(event.keyCode==13)event.keyCode=9"  >
  ...
  <tr>
  	<td align="center" colspan="4">
		<input type="button" name="button" value="修改基本信息" style="width:120;height:23 " onClick="doModify();">
		<input type="button" name="button" value="修改登录密码" style="width:120;height:23 " onClick="doChangePsw();">
	</td>
  </tr>
</table>
</form>
...
<script language=javascript>
  function doModify()
  {
	window.top.indexFrame.frames['manFrame'].location = './MainServlet_sys?fid=UII00.00.03.08&mode=before'
  }

  function doChangePsw()
  {
	window.top.indexFrame.frames['manFrame'].location = './MainServlet_sys?fid=UII00.00.03.07&mode=before'
  }
