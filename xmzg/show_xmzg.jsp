...
<!-- <TABLE class=table style="BORDER-COLLAPSE: collapse" borderColor=#6595d6 cellSpacing=0 cellPadding=3 width="90%" align=center bgColor=#ffffff border=1>-->
  ...
  <tr>
  	<td align="center" colspan="4">
		<input type="button" name="button" value="返回到整改列表" style="width:120;height:23 " onClick="doReturn();">
	</td>
  </tr>
</table>
</form>
...
<script language=javascript>
  function doReturn()
  {
	window.top.indexFrame.frames['manFrame'].location = './MainServlet_sys?fid=UII00.04.03.01<%=filter_str%>'
  }
