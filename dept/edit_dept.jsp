...
<!-- <TABLE class=table style="BORDER-COLLAPSE: collapse" borderColor=#6595d6 cellSpacing=0 cellPadding=3 width="90%" align=center bgColor=#ffffff border=1>-->
	...
	<input type="hidden" name="fid" id="fid" value="UII00.00.02.04"><input type="hidden" name="id" id="id" value="<%=crs.getString("id")%>">
		<%
	int ik = 0;
...
<script language=javascript>
  ...
  {
    formHead.target = "submitframe";
	document.getElementById("fid").value="UII00.00.02.03";
	formHead.submit();
	//alert("已提交");
  }
  function doClose()
  ...
  function checkfilter()
  {
	<%if(Integer.parseInt(mypri)==3){
	%> 
		document.getElementById("dept_emp_num").disabled=true;
		document.getElementById("dept_name").disabled=true;
		document.getElementById("admin_name").disabled=true;
		document.getElementById("admin_account").disabled=true;
		document.getElementById("dept_dwlx").disabled=true;
		<%
