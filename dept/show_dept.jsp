...
try{
	  ...
	  System.out.println("qweqwe==================crs.size()"+crs.size());
		crs.next();
	  }
...
<script language=javascript>
  function doReturn()
  {
	window.top.indexFrame.frames['manFrame'].location = './MainServlet_sys?fid=UII00.00.02.01<%=Integer.parseInt(mypri)<=3?filter_str:""%>'
  }
