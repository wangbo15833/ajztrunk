...
%>
<HTML><HEAD><TITLE>建设工程安全管理服务系统-秦皇岛微讯信息技术有限公司</TITLE>
  ...
  <TR vAlign=center>
    <TD align=middle>
      <TABLE  style="BORDER-RIGHT: 1px solid; BORDER-TOP: 1px solid; BORDER-LEFT: 1px solid; BORDER-BOTTOM: 1px solid" cellSpacing=0 cellPadding=0 width=796 align=center border=0>
        <TBODY>
        <TR><TD background=imags/login/top_bg.gif colSpan=2 height=62 ><div style=" height:30px; margin-bottom:10px; vertical-align:middle;font-size:24px;color:#2A3FFF; font-weight:bold; text-align:center">建设工程安全管理服务系统（重新登录）</div></TD></TR>
        <TR>
                ...
                <TD width=304>
                  <TABLE height=143 cellSpacing=0 cellPadding=0 width="100%" bgColor=#ffffff border=0>
                    ...
                    <TR><input type="hidden" name="fid" value="F00.00.00.05">
                      ...
                      <TD><INPUT class="textinput" style="WIDTH: 160px" name="username" value="<%=request.getParameter("username")%>"> <BR></TD>
					</TR>
...
<script>
	alert('登录失败：<%=eventResponse.getErrorMessage()%>！');
