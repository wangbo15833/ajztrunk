...
%>
<HTML><HEAD><TITLE>汇信科技生产管理系统</TITLE>
  ...
  <TR vAlign=center>
    <TD align=middle>
      <TABLE  style="BORDER-RIGHT: 1px solid; BORDER-TOP: 1px solid; BORDER-LEFT: 1px solid; BORDER-BOTTOM: 1px solid" cellSpacing=0 cellPadding=0 width=796 align=center border=0>
        ...
        <TR><TD background=imags/login/top_bg.gif colSpan=2 height=62 ><div style=" margin-bottom:10px; vertical-align:middle;font-size:24px;color:#2A3FFF; font-weight:bold; text-align:center">&nbsp;汇信科技生产管理系统(重新登录)</div></TD></TR>
				<!--
        ...
        <TR>
          <TD width=389 bgColor=#f7f7ff>
            ...
            <img height=199 alt=""  src="login/imags/login/sys_title.gif" width=389 border=0 name=登录界面_r5_c1></TD>
          <TD width=405 bgColor=#f7f7ff>
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD><IMG height=33 alt=""  src="login/imags/login/login_left.jpg" width=36 border=0 name=登录界面_r4_c2></TD>
                <TD background=login/imags/login/login_top.gif>&nbsp;</TD>
                <TD><IMG height=33 alt=""  src="login/imags/login/login_right.jpg" width=34 border=0  name=登录界面_r4_c4></TD>
                <TD width=31 bgColor=#f7f7ff rowSpan=3>&nbsp;</TD></TR>
              <TR>
                <TD background=login/imags/login/login_left_bg.gif>&nbsp;</TD>
                <TD width=304>
                  <TABLE height=143 cellSpacing=0 cellPadding=0 width="100%" bgColor=#ffffff border=0>
                    ...
                    <TR><input type="hidden" name="fid" value="F00.00.00.05">
											<input type="hidden" name="companyName" value="hx">
                      <TD align=right width="30%"><SPAN class=style1><FONT color=#8c8e8c>用户名：</FONT></SPAN></TD>
                      <TD><INPUT class="textinput" style="WIDTH: 160px" name="username" onKeyDown="if(event.keyCode==13)event.keyCode=9" value="<%=request.getParameter("username")%>"> <BR></TD>
					</TR>
                    ...
                    <TR align=middle>
                      <TD colSpan=2>
                        <TABLE width=180>
                          <TBODY>
                          <TR>
                            <TD><A href="javascript:login();"><IMG  src="login/imags/login/denglu.gif" border=0></A>&nbsp;</TD>
                            <TD><A href="#"><IMG src="login/imags/login/zhuce.gif" border=0></A>&nbsp;</TD>
						  </TR>
						  </TBODY>
						  </TABLE>
					  </TD>
                	...
                	<TD background=login/imags/login/login_right_bg.gif>&nbsp;</TD>
						  </TR>
						  <TR>
							<TD colSpan=3><IMG height=47 alt="" src="login/imags/login/login_bottom.gif" width=374 border=0></TD>
						 </TR>
						</TBODY>
					   </TABLE>
			         </TD>
          ...
          <TD colSpan=2>
            <TABLE cellSpacing=0 cellPadding=4 width="100%" border=0>
              ...
              <TR>
				...
				-->
				<FONT color=#8c8e8c>版权：长治汇信科技有限公司Copyright@2009 <br>
				制作：天工制造业信息化应用研究所<br>
