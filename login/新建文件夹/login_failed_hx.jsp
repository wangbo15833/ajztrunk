...
/*
CachedRowSet crs_ba_company = (CachedRowSet)request.getAttribute("crs_ba_company");
crs_ba_company.next();
String 	companyName = crs_ba_company.getString("companyName");
*/
    ...
    <TD align=middle>
      <TABLE  style="BORDER-RIGHT: 1px solid; BORDER-TOP: 1px solid; BORDER-LEFT: 1px solid; BORDER-BOTTOM: 1px solid" cellSpacing=0 cellPadding=0 width=796 align=center border=0>
        ...
        <TR><TD background=../ftxh/imags/login/top_bg.gif colSpan=2 height=62 
				><div style=" margin-bottom:10px; vertical-align:middle;font-size:24px;color:#2A3FFF; font-weight:bold; text-align:center">汇信科技生产管理系统</div></TD></TR>
       <TR>
                      ...
                      <TD colSpan=2>
                        <TABLE width=180>
                          ...
                          <TR>
                            ...
                            <TD><A href="user/regist.jsp"><IMG src="../ftxh/imags/login/zhuce.gif" border=0></A>&nbsp;</TD>
						  </TR>
						  </TBODY>
						  </TABLE>
					  </TD>
          ...
          <TD colSpan=2>
            <TABLE cellSpacing=0 cellPadding=4 width="100%" border=0>
              ...
              <TR>
                ...
                <TD><div class=style1>
				<FONT color=#8c8e8c>版权：汇信科技长治工厂Copyright@2009 <br>
				制作：天工制造业信息化应用研究所<br>
