...
<HTML><HEAD><TITLE>机械学院工艺平台系统</TITLE>
  ...
  <TR vAlign=center>
    <TD align=middle>
      <TABLE  style="BORDER-RIGHT: 1px solid; BORDER-TOP: 1px solid; BORDER-LEFT: 1px solid; BORDER-BOTTOM: 1px solid" cellSpacing=0 cellPadding=0 width=796 align=center border=0>
        ...
        <TR><TD background=imags/login/top_bg.gif colSpan=2 height=62 ><div style=" margin-bottom:10px; vertical-align:middle;font-size:24px;color:#2A3FFF; font-weight:bold; text-align:center">&nbsp;机械学院工艺平台系统</div></TD></TR>
				<!--
                ...
                <TD width=304>
                  <TABLE height=143 cellSpacing=0 cellPadding=0 width="100%" bgColor=#ffffff border=0>
                    ...
                    <TR><input type="hidden" name="fid" value="F00.00.00.05">
                      ...
                      <TD><INPUT class="textinput" style="WIDTH: 160px" name="username" onKeyDown="if(event.keyCode==13)event.keyCode=9" value="gypt"> <BR></TD>
					</TR>
                    
					<TR>
                      <TD align=right><SPAN class=style1><FONT color=#8c8e8c>密&nbsp;&nbsp;码：</FONT></SPAN></TD>
                      <TD><INPUT class="textinput" style="WIDTH: 160px"  type="password" name="password" value="gypt"><BR></TD>
					</TR>
          ...
          <TD colSpan=2>
            <TABLE cellSpacing=0 cellPadding=4 width="100%" border=0>
              ...
              <TR>
				...
				-->
				<FONT color=#8c8e8c>版权：机械学院Copyright@2009 <br>
				制作：天工制造业信息化应用研究所<br>
