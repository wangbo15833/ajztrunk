  ...
  <TR vAlign=center>
    <TD align=middle>
      <TABLE  style="BORDER-RIGHT: 1px solid; BORDER-TOP: 1px solid; BORDER-LEFT: 1px solid; BORDER-BOTTOM: 1px solid" cellSpacing=0 cellPadding=0 width=796 align=center border=0>
        ...
        <TR><TD background=imags/login/top_bg.gif colSpan=2 height=62 ><div style=" margin-bottom:10px; vertical-align:middle;font-size:24px;color:#2A3FFF; font-weight:bold; text-align:center">&nbsp;DOMQC集成控制管理系统(密码修改)</div></TD></TR>
				<!--
              ...
              <TR>
                ...
                <TD width=304>
                  <TABLE height=143 cellSpacing=0 cellPadding=0 width="100%" bgColor=#ffffff border=0>
                    <TBODY>
					<form name="formHead" action="../FSY000.000.013.91"  onKeyDown="if(event.keyCode==13)login()"  method="post">
                      ...
                      <TD colSpan=2>
                        <TABLE width=180>
                          ...
                          <TR>
														...
														<TD><A href="#"><input type="button" value="确定" style="width:76px;"></A>&nbsp;</TD>
