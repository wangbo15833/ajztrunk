  ...
  <TR vAlign=center>
    <TD align=middle>
      <TABLE  style="BORDER-RIGHT: 1px solid; BORDER-TOP: 1px solid; BORDER-LEFT: 1px solid; BORDER-BOTTOM: 1px solid" cellSpacing=0 cellPadding=0 width=796 align=center border=0>
        <TR><TD background=imags/login/top_bg.gif colSpan=2 height=62 style="vertical-align:top;padding-top:8px;"><div style=" height:30px; margin-bottom:10px; vertical-align:middle;font-size:24px;color:#2A3FFF; font-weight:bold; text-align:center">&nbsp;建设工程安全管理服务系统（重新登录）</div></TD></TR>        
        <TR>
