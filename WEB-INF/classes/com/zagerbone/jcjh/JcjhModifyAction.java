...
public class JcjhModifyAction extends BaseActionSupport
{

	public JcjhModifyAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		System.out.println("***=== JcjhModifyAction mode is "+ mode+" ===***");
		try
		{
			...
			System.out.println("***=== the QueryString in JcjhFindListAction is "+queryString+" ===***");
			query.info();
			...
			Jcjh jcjh = (Jcjh)processEvent(event);
			String s = jcjhdao.modifyJcjh(jcjh);
			eventresponse.setSuccessFlag(true);
		...
		throws BussinessProcessException
	{
		Jcjh jcjh = new Jcjh();
		HashMap hashmap = event.getBody();		
		jcjh.setid((String)hashmap.get("id"));
		hashmap.remove("id");
