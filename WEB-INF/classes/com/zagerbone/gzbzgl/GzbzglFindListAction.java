...
// Source File Name:   GzbzglFindListAction.java
...
public class GzbzglFindListAction extends BaseActionSupport
{

	public GzbzglFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = null;
			if (i == 0)
				query1 = gzbzgldao.findGzbzglList_noPage(query);
			else
				query1 = gzbzgldao.findGzbzglList(query);
