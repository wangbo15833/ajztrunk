...
//			XmzgDAOFactory, XmzgDAO

public class XmzgFindListAction extends BaseActionSupport
{

	public XmzgFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = xmzgdao.findXmzgList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in XmzgFindListAction is "+s3+" ===***");
		query.info();
