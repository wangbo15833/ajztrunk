...
public class JdjlModifyAction extends BaseActionSupport
{

	public JdjlModifyAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		System.out.println("***=== JdjlModifyAction mode is "+ mode+" ===***");
		try
		{
			...
			Jdjl jdjl = (Jdjl)processEvent(event);
			String s = jdjldao.modifyJdjl(jdjl,event.getRequest());
			eventresponse.setSuccessFlag(true);
