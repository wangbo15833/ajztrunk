...
public class EmpFindListAction extends BaseActionSupport
{

	public EmpFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = empdao.findEmpList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in EmpFindListAction is "+s3+" ===***");
		query.info();
