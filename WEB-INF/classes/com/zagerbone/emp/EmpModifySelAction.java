...
public class EmpModifySelAction extends BaseActionSupport
{

	public EmpModifySelAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		System.out.println("***=== EmpModifySelAction mode is "+ mode+" ===***");
		try
		{
			...
			Emp emp = (Emp)processEvent(event);
			String s = empdao.modifyEmpSel(emp,event.getRequest());
			eventresponse.setSuccessFlag(true);
			eventresponse.setBody(s);
			System.out.println("*** === step 2 in EmpModifySelAction === ***");
