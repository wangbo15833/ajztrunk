...
//			JcbzDAOFactory, JcbzDAO

public class JcbzFindListAction extends BaseActionSupport
{

	public JcbzFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = jcbzdao.findJcbzList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in JcbzFindListAction is "+s3+" ===***");
		query.info();
