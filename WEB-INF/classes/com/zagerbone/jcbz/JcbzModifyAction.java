...
public class JcbzModifyAction extends BaseActionSupport
{

	public JcbzModifyAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		System.out.println("***=== JcbzModifyAction mode is "+ mode+" ===***");
		try
		{
			...
			Jcbz jcbz = (Jcbz)processEvent(event);
			String s = jcbzdao.modifyJcbz(jcbz,event.getRequest());
			eventresponse.setSuccessFlag(true);
