...
public class GginfoDeleteAction extends BaseActionSupport
{

	public GginfoDeleteAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			System.out.println("===  step in GginfoDeleteAction === id is :"+s);
			String s1 = gginfodao.deleteGginfo(s,event.getRequest());
