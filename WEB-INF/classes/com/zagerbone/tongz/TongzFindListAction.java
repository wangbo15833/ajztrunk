...
//			TongzDAOFactory, TongzDAO

public class TongzFindListAction extends BaseActionSupport
{

	public TongzFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = tongzdao.findTongzList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in TongzFindListAction is "+s3+" ===***");
		query.info();
