...
public class FlfgModifyAction extends BaseActionSupport
{

	public FlfgModifyAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		System.out.println("***=== FlfgModifyAction mode is "+ mode+" ===***");
		try
		{
			...
			Flfg flfg = (Flfg)processEvent(event);
			String s = flfgdao.modifyFlfg(flfg,event.getRequest());
			eventresponse.setSuccessFlag(true);
