...
public class TxinfoDeleteAction extends BaseActionSupport
{

	public TxinfoDeleteAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			System.out.println("===  step in TxinfoDeleteAction === id is :"+s);
			String s1 = txinfodao.deleteTxinfo(s,event.getRequest());
