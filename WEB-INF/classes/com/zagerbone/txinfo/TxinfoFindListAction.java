...
//			TxinfoDAOFactory, TxinfoDAO

public class TxinfoFindListAction extends BaseActionSupport
{

	public TxinfoFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = txinfodao.findTxinfoList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in TxinfoFindListAction is "+s3+" ===***");
		query.info();
