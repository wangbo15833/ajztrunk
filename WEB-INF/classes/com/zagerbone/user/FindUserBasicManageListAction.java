...
// Source File Name:   FindUserBasicManageListAction.java
...
public class FindUserBasicManageListAction extends BaseActionSupport
{

	public FindUserBasicManageListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = userdao.findUserBasicManageList(query);
