...
public class DeptCreateAction extends BaseActionSupport
{

	public DeptCreateAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		System.out.println("***=== DeptCreateAction mode is "+ mode+" ===***");
		try
		{
			...
			{				
				...
				log.info("***=== 新增单位类型 DeptCreateAction ===***");
				Dept dept = (Dept)processEvent(event);
				String s1 = deptdao.createDept(dept,event.getRequest());
				eventresponse.setSuccessFlag(true);
				eventresponse.setBody(s1);
				System.out.println("*** === step 2 in DeptModifyAction === ***");
