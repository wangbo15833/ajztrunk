...
public class DeptQueryListAction extends BaseActionSupport
{

	public DeptQueryListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = deptdao.findDeptList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in DeptQueryListAction is "+s3+" ===***");
		query.info();
