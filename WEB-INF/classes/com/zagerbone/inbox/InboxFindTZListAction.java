...
public class InboxFindTZListAction extends BaseActionSupport
{

	public InboxFindTZListAction()
	{
	}
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in InboxFindTZListAction is "+s3+" ===***");
		query.info();
