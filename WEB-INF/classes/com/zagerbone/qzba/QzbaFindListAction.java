...
//			QzbaDAOFactory, QzbaDAO

public class QzbaFindListAction extends BaseActionSupport
{

	public QzbaFindListAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = qzbadao.findQzbaList(query,event.getRequest());
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in QzbaFindListAction is "+s3+" ===***");
		query.info();
