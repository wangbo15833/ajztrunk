...
public class SubinfoQueryDetailAction extends BaseActionSupport
{

	public SubinfoQueryDetailAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		System.out.println("***=== SubinfoQueryDetailAction mode is "+ mode+" ===***");
		try
		{
			
			HashMap hashmap = event.getBody();
			String sub_code = (String)hashmap.get("sub_code");
			System.out.println("item wanna be showdetail 's sub_code is : "+sub_code);
