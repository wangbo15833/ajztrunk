...
public class SubinfoQueryConAction extends BaseActionSupport
{

	public SubinfoQueryConAction()
	{
	}
	...
	public EventResponse perform(Event event)
	{
		...
		try
		{
			...
			Query query1 = subinfodao.findSubinfoList(query,request);
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in SubinfoQueryConAction is "+s3+" ===***");
		query.info();
