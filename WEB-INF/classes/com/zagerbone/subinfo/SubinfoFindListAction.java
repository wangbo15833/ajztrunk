...
public class SubinfoFindListAction extends BaseActionSupport
{

	public SubinfoFindListAction()
	{
	}
		...
		throws BussinessProcessException
	{
		...
		System.out.println("***=== the QueryString in SubinfoFindListAction is "+s3+" ===***");
		query.info();
