...
if(eventResponse.isSuccessFlag()){ 
	...
	if(eventResponse.getFunctionID().equals("FCL00.00.09.01")){ 
        ...
        <script language=JavaScript>
			parent.location = "MainServlet_sys?fid=FCL00.00.09.02&listMode=list";
	...
	else if(eventResponse.getFunctionID().equals("FCL00.00.09.04")){
	...
	else if(eventResponse.getFunctionID().equals("FCL00.00.09.05")){ 
