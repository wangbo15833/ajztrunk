...
%>
<%
String [] col_name 		= {"id","work_unitCode","work_unit"};
String [] col_headname 	= {"id","车辆单位编号","车辆单位名称"};
%>
<head>
<title>车辆单位列表</title>
...
<tr id='sub_title'><td align="center"><font size="+1">车辆单位列表</font></td></tr>
</table>
...
<td width="15%" align="center" class="left_title_1" style="display:<%=operStyle_cancal%>">操作</td>
<%
for(int jk=0; jk<col_name.length; jk++){
	%>
  <td width="20%" align="center" nowrap="nowrap" style="padding-left:2px; padding-right:2px;" class="left_title_1"><span class="left_title_2" ><%=col_headname[jk]%></span></td>
  <%
}
%>
</tr>
<tr   style="font-size:13px" ><!--  显示英文标题  -->
	...
	<td width="15%" align="center" class="left_title_1" style="display:<%=operStyle_cancal%>"></td>
	<%
	for(int jk=0; jk<col_name.length; jk++){
	%>
	<td width="20%" align="center" nowrap="nowrap" style="padding-left:2px; padding-right:2px;" class="left_title_1"><span class="left_title_2" ><%=col_name[jk]%></span></td>
	<%
	}
	%>
</tr>
...
%>
	...
	else
	{
		...
		<a href="MainServlet_sys?fid=FCL00.00.09.03&id=<%=crs.getString("id")%>" target="_self"><font color="#ff0000" class="tdrecord" style="font-size:12px" >修改</font></a>
