...
<form name="formHead" action="./MainServlet_sys" target="sframe" onKeyDown="if(event.keyCode==13)event.keyCode=9" style="padding-top:30px;">
    <input type="hidden" name="fid" value="UII00.01.03.03">
...
<script language="javascript">
	function  checknow()
	{
		if(<%=flag1%>){
		alert("增加成功！");
	  window.top.indexFrame.frames['manFrame'].location = './MainServlet_sys?fid=UII00.01.03.01'
		}
	}
	checknow();
</script>
