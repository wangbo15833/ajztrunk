...
<!-- <TABLE class=table style="BORDER-COLLAPSE: collapse" borderColor=#6595d6 cellSpacing=0 cellPadding=3 width="90%" align=center bgColor=#ffffff border=1>-->
	...
	<input type="hidden" name="fid" value="UII00.00.01.04">
	<%
	int ik = 0;
	do {
	%>
...
<script language=javascript>
  ...
  {
	if(<%=flag1%>){
	 window.top.indexFrame.frames['manFrame'].location = '../MainServlet_sys?fid=UII00.00.01.01'
	}
  }
  checknow();
</script>
