...
%>
<%
String [] col_name 			= {"id","parameteName","parameteChName","configYPerValue","configYMinValue","configYValueCount","pageFreshTime"};
String [] col_headname 	= {"id","参数名称","参数中文名称","Y轴单位间隔","Y轴最小单位","Y轴长度","刷新频率"};
%>
<head>
...
function confirmButton(operationMode, tr_row,id_value){
	...
	submitframe.location = "MainServlet_sys?fid=FCL00.00.07.05&id="+id_value;
	return ok;
}
</script> 
</head>
<body leftmargin="0" topmargin="0" rightmargin="0">
<div id="man_zone" style="padding-top:20px; padding-left:5px;">
...
<tr id='sub_title'><td align="center"><font size="+1">曲线参数列表</font></td></tr>
</table>
...
%>
	...
	else
	{
     ...
     <tr  bgcolor='FFFFFF' class='font_px12' id="tr_<%=i_row%>">
		...
		<a href="MainServlet_sys?fid=FCL00.00.07.03&id=<%=crs.getString("id")%>" target="_self"><font color="#ff0000" class="tdrecord" style="font-size:12px" >修改</font></a>
		<a onclick="return confirmButton('delete', <%=i_row%>, <%=crs.getString("id")%>);" href="MainServlet_sys?fid=FCL00.00.07.05&id=<%=crs.getString("id")%>" target="submitframe"><font color="#ff0000" class="tdrecord" style="font-size:12px" >删除</font></a>
		</td>
		...
		for(int jk=0; jk<col_name.length; jk++){
			...
			else if(col_name[jk].equals("Couttime") || col_name[jk].equals("Cjtime") || col_name[jk].equals("Tstime")|| col_name[jk].equals("dataCreateTime")){
